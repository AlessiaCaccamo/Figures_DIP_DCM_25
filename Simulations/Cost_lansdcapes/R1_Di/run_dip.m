...
for i=1:2 % for each dataset
    ...
    save(['/home/links/ac1376/Simulations/DIP_sim_4/GA_LFP_dataset_' num2str(i) '_nsim_' num2str(nsim) '.mat'], 'out'); 
    ...
    save(['/home/links/ac1376/Simulations/DIP_sim_4/DCM_LFP_dataset_' num2str(i) '_nsim_' num2str(nsim) '.mat'], 'DCM');
    end 
end
