...
cov_values_pre(16) = cov(30);
cov_values_pre(17) = cov(31);
cov_values_pre(18) = cov(32);
cov_values_pre(19) = cov(33);
cov_values_pre(20) = cov(34);
cov_values_pre(21) = cov(35);
cov_values_pre(22) = cov(36);
cov_values_pre(23) = cov(37);
cov_values_pre(24) = cov(38);
cov_values_pre(25) = cov(39);
cov_values_pre(26) = cov(40);
cov_values_pre(27) = cov(41);
...
for ii = 1:15 % Use the log-scalings to calculate Cohen's d between parameters of the 2 datasets
...
diff_samples = random_samples_post - random_samples_pre;
D(ii) = mean(diff_samples);
BCI(ii,:) = prctile(diff_samples, [2.5, 97.5]);
...
filtered_mu_diff = D(valid_idx)';
filtered_BCI = BCI(valid_idx, :);
filtered_params = paramsvec(valid_idx);

% mark significant parameters as 1
signs = sign(d(valid_idx));  % effect direction?
% directional info
significance_matrix(find(valid_idx)) = signs;
